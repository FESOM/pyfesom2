...
@pytest.fixture(
    ...
    params=[
        datasets.core,
        datasets.arctic_1km,
        datasets.tutorial_dataset,
        datasets.rossby42,
        datasets.rossby42_level,
        datasets.rossby42_spatial,
    ],
)
...
@pytest.fixture(
    scope="module", params=[datasets.cmip6_lr, datasets.cmip6_mr, datasets.cmip6_hr]
)
...
def check_dataset(dataset):
    ...
    assert all(
        [coord in dataset.coords for coord in ["lon", "lat"]]
    )  # add faces eventually
